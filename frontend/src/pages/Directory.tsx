...
export default function Directory() {
  ...
  // Only HR admin can view directory
  if (!user || user.role !== 'hr_admin') {
    return (
      <div className="text-center py-12 text-stone-500">
        <p className="text-lg font-medium">Access Denied</p>
        <p className="text-sm">Only HR Administrators can view the complete employee directory.</p>
        <p className="text-sm mt-4">For your profile, go to <strong>My Profile</strong>.</p>
      </div>
    )
  }
